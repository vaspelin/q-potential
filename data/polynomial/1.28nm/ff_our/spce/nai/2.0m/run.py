...
pdb = PDBFile("2.0m_box.pdb")
PDBFile.writeFile(pdb.topology, pdb.positions, open("2.0m_box.pdb", 'w'))
...
nonbonded.addGlobalParameter( 'Rc', 1.280000*nanometers )           # 'Rc' can now be used in energy function
nonbonded.addGlobalParameter( 'f', elec_to_kJmol ) # 'lB' bjerrum length in nm and kJ/mol

nonbonded.setEnergyFunction(
    'f * charge1 * charge2 * (0.1e1 - 0.9e1 / 0.20e2 * (r/Rc) - 0.27e2 / 0.76e2'     ' * (r/Rc) ^ 2 - 0.307e3 / 0.1140e4 * (r/Rc) ^ 3 - 0.73e2 / 0.380e3'     ' * (r/Rc) ^ 4 - 0.47e2 / 0.380e3 * (r/Rc) ^ 5 - 0.73e2 / 0.1140e4'     ' * (r/Rc) ^ 6 - (r/Rc) ^ 7 / 0.76e2 + 0.11e2 / 0.380e3 * (r/Rc) ^ 8'     ' + 0.71e2 / 0.1140e4 * (r/Rc) ^ 9 + 0.33e2 / 0.380e3 * (r/Rc) ^ 10'     ' + 0.39e2 / 0.380e3 * (r/Rc) ^ 11 + 0.25e2 / 0.228e3 * (r/Rc) ^ 12'     ' + 0.41e2 / 0.380e3 * (r/Rc) ^ 13 + 0.37e2 / 0.380e3 * (r/Rc) ^ 14'     ' + 0.89e2 / 0.1140e4 * (r/Rc) ^ 15 + (r/Rc) ^ 16 / 0.20e2 + (r/Rc) ^ 17'     ' / 0.76e2 - 0.37e2 / 0.1140e4 * (r/Rc) ^ 18 - 0.33e2 / 0.380e3'     ' * (r/Rc) ^ 19 - 0.3e1 / 0.20e2 * (r/Rc) ^ 20) / r'     ' + 4 * epsilon * ( (sigma/r)^12 - (sigma/r)^6 )'     ' ; sigma = 0.5 * (sigma1+sigma2); epsilon = sqrt( epsilon1*epsilon2 )'
)
